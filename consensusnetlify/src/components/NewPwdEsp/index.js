    ...
    <nav className="navbar-global-connected">
      <div className="app-title-connected">
        ...
        <div className="navbar-subtitle-connected">
            ...
            <span className='account-to-recup'><strong>Introduzca la dirección de correo electrónico de la cuenta para la cual desea cambiar la contraseña</strong></span>
        <div className="content-forget">
            ...
            <div className="inputForm-recuperation">
               ...
               <button disabled={disabled}className='oui'>Cambiar la contraseña</button>
            </div>
            </form>
        </div>
        </>
