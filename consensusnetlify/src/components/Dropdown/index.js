      ...
      {isOpen && (
        <div className="dropdown-list" onClick={(e) => e.stopPropagation()}>
          <div className="dropdown-list-item" onClick={(e) => handleOptionClick('en')}>
            <NavLink className='to-en' to='/en' onClick={handleItemClick}><img className='flags' src={EN} alt="en"></img><span className='countryName'>English</span></NavLink>
          </div>
          ...
          <div className="dropdown-list-item" onClick={(e) => handleOptionClick('esp')}>
            <NavLink className='to-esp' to='/esp' onClick={handleItemClick}><img className='flags' src={ESP} alt="esp"></img><span className='countryName'>Español</span></NavLink>
          </div>
        </div>
      )}
    </div>
