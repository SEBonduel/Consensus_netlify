  ...
  />
    ...
    <nav className="navbar-global-connected">
      <div className="app-title-connected">
        ...
        <div className="profile-content">
          <div className="head">
            ...
            <h1 className="slogan">Welcome to your account {pseudo}</h1>
            <DropdownProfile/>
                </div>
            <div className="confidential-content-and-avatar">

              <div className="confidential-content">
                <span className='confidential-content-title'><strong>Confidential data</strong></span>
                <div className='confidential-content-email'>
                  <TextField disabled="true" onChange={handleChange} value={userSession.email} id="email2" type="email" label="Email address" variant="filled" style={{backgroundColor: "#fdf4e3", borderRadius: '5px'}}/>
                </div>
                <div className='confidential-content-pwd'>
                  <NavLink to="NewPwdEn"><button className='change-pwd'>Change your password</button></NavLink>
                </div>
              </div>
              ...
              <div className="personnal-content">
                <span className='personnal-content-title'><strong>Personnal data</strong></span>
                  <span className='personnal-content-email-title'>New username :</span>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button className='change-pseudo' disabled={isDisabled()} type="submit">Submit</button>
      </form>
    </div>
