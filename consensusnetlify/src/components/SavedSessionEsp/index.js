    ...
    return (
        <div className='past-session-display'>
          <div className='past-session-description'>
            <h6 className='past-session-name'>Nombre de la sesión : {data.name}</h6>
            <h6 className='past-session-date'>Fecha de la sesión : {data.date}</h6>
          </div>
...
export default SavedSessionEsp;
