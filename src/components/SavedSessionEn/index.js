    ...
    return (
        <div className='past-session-display'>
          <div className='past-session-description'>
            <h6 className='past-session-name'>Session name : {data.name}</h6>
            <h6 className='past-session-date'>Session date : {data.date}</h6>
          </div>
