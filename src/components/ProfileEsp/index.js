  ...
  />
    ...
    <nav className="navbar-global-connected">
      <div className="app-title-connected">
        ...
        <div className="profile-content">
          <div className="head">
            ...
            <h1 className="slogan">Bienvenido a tu cuenta {pseudo}</h1>
            <DropdownProfile/>
                </div>
            <div className="confidential-content-and-avatar">

              <div className="confidential-content">
                <span className='confidential-content-title'><strong>Datos confidenciales</strong></span>
                <div className='confidential-content-email'>
                  <TextField disabled="true" onChange={handleChange} value={userSession.email} id="email2" type="email" label="Dirección de correo electrónico" variant="filled" style={{backgroundColor: "#fdf4e3", borderRadius: '5px'}}/>
                </div>
                <div className='confidential-content-pwd'>
                  <NavLink to="NewPwdEsp"><button className='change-pwd'>Cambiar su contraseña</button></NavLink>
                </div>
              </div>
              ...
              <div className="personnal-content">
                <span className='personnal-content-title'><strong>Datos personales</strong></span>
                  <span className='personnal-content-email-title'>Nuevo nombre de usuario :</span>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button className='change-pseudo' disabled={isDisabled()} type="submit">Validar</button>
      </form>
    </div>
